...
const TermsAndConditions = () => {
    ...
    const terms = [
        ...
        },
        {
            ...
            text: 'In some cases, it may be necessary to verify your income. If income verification is required in order to complete your enrollment, you authorize Allied Premium Insurance, LLC to submit an income attestation letter on your behalf with the information that you have provided.'
        },
        {
            isSelected: false,
            title: 'Consent to Enrollment; Verification of Information',
            text: 'By supplying my initials and signing below, I hereby provide consent and authorization to Allied Premium Insurance, LLC to enroll me and/or my family in a health insurance plan through the ACA Marketplace at no cost to me. I grant permission for Allied Premium Insurance, LLC to access my healthcare.gov account for the purpose of quoting, enrolling, and maintaining my health insurance. If I already have a plan, I request that Allied Premium Insurance, LLC and its agents become my Agent of Record and switch me to a better plan if one is available. This consent will remain in effect unless and until rescinded by you in writing, by emailing.'
        },
        {
